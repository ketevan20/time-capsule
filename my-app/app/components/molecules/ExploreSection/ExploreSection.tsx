...
import bg from '../../../../public/thinkerBackground.svg'
            ...
            <div className='flex-2 grid grid-cols-5 grid-rows-2 gap-5 max-sm:grid-cols-1 max-sm:grid-rows-[auto_auto]'>
                ...
                <motion.div initial={{opacity: 0, x: 100}} whileInView={{opacity: 1, x:0}} transition={{duration: 1, ease: 'anticipate'}} viewport={{once: true}} className='relative z-20 sm:col-span-3 sm:row-span-2 bg-linear-to-b from-black to-black/0 backdrop-blur-sm rounded-2xl border-[0.4px] border-[#FFB800] p-4 flex flex-col gap-2 items-center text-center'>
                    ...
                    <div className='relative min-w-55 max-w-[90%]'>
                        ...
                        <Image width={225} height={365} src={bg} alt='Thinker Background' className="max-w-full" priority/>
                ...
                <motion.div initial={{opacity: 0, x: -100}} whileInView={{opacity: 1, x:0}} transition={{duration: 1, ease: 'anticipate'}} viewport={{once: true}} className='relative overflow-hidden z-10 sm:col-span-2 bg-linear-to-b from-black to-black/0 backdrop-blur-sm px-5 py-4 rounded-2xl border-[0.4px] border-[#FFB800]'>
                ...
                <motion.div initial={{opacity: 0, x: -100}} whileInView={{opacity: 1, x:0}} transition={{duration: 1, ease: 'anticipate'}} viewport={{once: true}} className='relative z-10 sm:col-span-2 bg-linear-to-b from-black to-black/0 backdrop-blur-sm px-5 py-4 rounded-2xl border-[0.4px] border-[#FFB800] font-sans text-white'>
